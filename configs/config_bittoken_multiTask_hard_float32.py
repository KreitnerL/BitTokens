...
train_set_paths_and_curriculum_types = {
    ...
    f"{DATA_PATH}/Exponentiation_binary_uniform_train_30M.csv.gz": (DATASET_CURRICULUM_TYPE.CURRICULUM, f"{DATA_PATH}/cache/bittoken_gpt2_47200109/35075781"),
    f"{DATA_PATH}/Exponentiation_decimal_uniform_train_30M.csv.gz": (DATASET_CURRICULUM_TYPE.ENDGAME, f"{DATA_PATH}/cache/bittoken_gpt2_47200109/84637502"),
    ...
    f"{DATA_PATH}/Mean_binary_uniform_train_30M.csv.gz": (DATASET_CURRICULUM_TYPE.CURRICULUM, f"{DATA_PATH}/cache/bittoken_gpt2_47200109/33586275"),
    f"{DATA_PATH}/Mean_decimal_uniform_train_30M.csv.gz": (DATASET_CURRICULUM_TYPE.ENDGAME, f"{DATA_PATH}/cache/bittoken_gpt2_47200109/97587995"),
    f"{DATA_PATH}/Std_binary_uniform_train_30M.csv.gz": (DATASET_CURRICULUM_TYPE.CURRICULUM, f"{DATA_PATH}/cache/bittoken_gpt2_47200109/99798559"),
    f"{DATA_PATH}/Std_decimal_uniform_train_30M.csv.gz": (DATASET_CURRICULUM_TYPE.ENDGAME, f"{DATA_PATH}/cache/bittoken_gpt2_47200109/98036116"),
...
train_paths_metrics_dataset_types: dict[str, tuple[str, str]] = {
    ...
    f"{DATA_PATH}/Exponentiation_binary_uniform_val_10k.csv.gz": (NUMERIC_METRIC, "curriculum_number"),
    f"{DATA_PATH}/Exponentiation_decimal_uniform_val_10k.csv.gz": (NUMERIC_METRIC, "efficient_number_prompt"),
    ...
    f"{DATA_PATH}/Mean_binary_uniform_val_10k.csv.gz": (NUMERIC_METRIC, "curriculum_number"),
    f"{DATA_PATH}/Mean_decimal_uniform_val_10k.csv.gz": (NUMERIC_METRIC, "efficient_number_prompt"),
    f"{DATA_PATH}/Std_binary_uniform_val_10k.csv.gz": (NUMERIC_METRIC, "curriculum_number"),
    f"{DATA_PATH}/Std_decimal_uniform_val_10k.csv.gz": (NUMERIC_METRIC, "efficient_number_prompt"),
...
train_config.save_dir = f"{PROJECT_PATH}/trained/multiTask_hard/bittoken"
...
train_config.wandb_group = "multi_task_hard_bittoken"
...
test_paths_metrics_dataset_types_save_pred: dict[str, tuple[str, str, bool]] = {
    ...
    f"{DATA_PATH}/Exponentiation_decimal_uniform_test_10k.csv": (NUMERIC_METRIC, "efficient_number_prompt", True),
    ...
    f"{DATA_PATH}/Mean_decimal_uniform_test_10k.csv": (NUMERIC_METRIC, "efficient_number_prompt", True),
    f"{DATA_PATH}/Std_decimal_uniform_test_10k.csv": (NUMERIC_METRIC, "efficient_number_prompt", True),
    f"{DATA_PATH}/val_text.txt": (MetricFunction.SCALED_PPL, "pretokenized_number", False)
}
