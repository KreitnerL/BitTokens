...
train_set_paths_and_curriculum_types = {
    ...
    f"{DATA_PATH}/Multiplication_binary_uniform_train_30M.csv.gz": (DATASET_CURRICULUM_TYPE.CURRICULUM, f"{DATA_PATH}/cache/sd_gpt2_43988927/62268622"),
    f"{DATA_PATH}/Multiplication_decimal_uniform_train_30M.csv.gz": (DATASET_CURRICULUM_TYPE.ENDGAME, f"{DATA_PATH}/cache/sd_gpt2_43988927/94881869"),
    f"{DATA_PATH}/DivM_binary_uniform_train_30M.csv.gz": (DATASET_CURRICULUM_TYPE.CURRICULUM, f"{DATA_PATH}/cache/sd_gpt2_43988927/62072059"),
    f"{DATA_PATH}/Division_decimal_uniform_train_30M.csv.gz": (DATASET_CURRICULUM_TYPE.ENDGAME, f"{DATA_PATH}/cache/sd_gpt2_43988927/26549495"),
...
train_paths_metrics_dataset_types: dict[str, tuple[str, str]] = {
    ...
    f"{DATA_PATH}/Multiplication_binary_uniform_val_10k.csv.gz": (MetricFunction.LOG_SMAPE, "curriculum"),
    f"{DATA_PATH}/Multiplication_decimal_uniform_val_10k.csv.gz": (MetricFunction.LOG_SMAPE, "efficient_prompt"),
    f"{DATA_PATH}/DivM_binary_uniform_val_10k.csv.gz": (MetricFunction.LOG_SMAPE, "curriculum"),
