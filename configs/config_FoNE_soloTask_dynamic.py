...
match TASK:
    case Task.ADDITION:
        train_set_paths_and_curriculum_types = {
            f"{DATA_PATH}/Addition_decimal_uniform_train_30M.csv.gz": (DATASET_CURRICULUM_TYPE.STANDARD, f"{DATA_PATH}/cache/bittoken_gpt2_47200109_pos/21903304"),
        }
    ...
    case Task.MULTIPLICATION:
        train_set_paths_and_curriculum_types = {
            f"{DATA_PATH}/Multiplication_decimal_uniform_train_30M.csv.gz": (DATASET_CURRICULUM_TYPE.CURRICULUM, f"{DATA_PATH}/cache/bittoken_gpt2_47200109_pos/94881869"),
    ...
    case Task.DIVISION:
        train_set_paths_and_curriculum_types = {
            f"{DATA_PATH}/Division_decimal_uniform_train_30M.csv.gz": (DATASET_CURRICULUM_TYPE.CURRICULUM, f"{DATA_PATH}/cache/bittoken_gpt2_47200109_pos/26549495"),
        }
        val_paths_metrics_dataset_types = {
    ...
    case Task.EXPONENTIATION:
        train_set_paths_and_curriculum_types = {
            f"{DATA_PATH}/Exponentation_decimal_uniform_train_30M.csv.gz": (DATASET_CURRICULUM_TYPE.CURRICULUM, f"{DATA_PATH}/cache/bittoken_gpt2_47200109_pos/13731216"),
        }
        val_paths_metrics_dataset_types = {
    ...
    case Task.MIN_MAX:
        train_set_paths_and_curriculum_types = {
            f"{DATA_PATH}/MinMax_decimal_uniform_train_30M.csv.gz": (DATASET_CURRICULUM_TYPE.STANDARD, f"{DATA_PATH}/cache/bittoken_gpt2_47200109_pos/21268272"),
        }
        val_paths_metrics_dataset_types = {
    ...
    case Task.INTERVAL:
        train_set_paths_and_curriculum_types = {
            f"{DATA_PATH}/Interval_decimal_uniform_train_30M.csv.gz": (DATASET_CURRICULUM_TYPE.STANDARD, f"{DATA_PATH}/cache/bittoken_gpt2_47200109_pos/15330129"),        }
        val_paths_metrics_dataset_types = {
    ...
    case Task.SORTING:
        train_set_paths_and_curriculum_types = {
            f"{DATA_PATH}/Sorting_decimal_uniform_train_30M.csv.gz": (DATASET_CURRICULUM_TYPE.STANDARD, f"{DATA_PATH}/cache/bittoken_gpt2_47200109_pos/25805100"),
        }
        val_paths_metrics_dataset_types = {
    ...
    case Task.MEAN:
        train_set_paths_and_curriculum_types = {
            f"{DATA_PATH}/Mean_decimal_uniform_train_30M.csv.gz": (DATASET_CURRICULUM_TYPE.CURRICULUM, f"{DATA_PATH}/cache/bittoken_gpt2_47200109_pos/58115172")
        }
        val_paths_metrics_dataset_types = {
    ...
    case Task.STD:
        train_set_paths_and_curriculum_types = {
            f"{DATA_PATH}/Std_decimal_uniform_train_30M.csv.gz": (DATASET_CURRICULUM_TYPE.CURRICULUM, f"{DATA_PATH}/cache/bittoken_gpt2_47200109_pos/69357492")
        }
        val_paths_metrics_dataset_types = {
    ...
    case Task.TEXT:
        train_set_paths_and_curriculum_types = {
            f"{DATA_PATH}/000_00000_train.txt": (DATASET_CURRICULUM_TYPE.STANDARD,  f"{DATA_PATH}/cache/bittoken_gpt2_47200109_pos/13591814")
        }
        val_paths_metrics_dataset_types = {
...
match TASK:
    case Task.ADDITION:
        test_paths_metrics_dataset_types_save_pred = {f"{DATA_PATH}/Addition_decimal_uniform_test_10k.csv": (MetricFunction.LOG_SMAPE, "efficient_number_prompt_pos", True)}
    case Task.MULTIPLICATION:
        test_paths_metrics_dataset_types_save_pred = {f"{DATA_PATH}/Multiplication_decimal_uniform_test_10k.csv": (MetricFunction.LOG_SMAPE, "efficient_number_prompt_pos", True)}
    case Task.DIVISION:
        test_paths_metrics_dataset_types_save_pred = {f"{DATA_PATH}/Division_decimal_uniform_test_10k.csv": (MetricFunction.LOG_SMAPE, "efficient_number_prompt_pos", True)}
    case Task.EXPONENTIATION:
        test_paths_metrics_dataset_types_save_pred = {f"{DATA_PATH}/Exponentation_decimal_uniform_test_10k.csv": (MetricFunction.LOG_SMAPE, "efficient_number_prompt_pos", True)}
    case Task.MIN_MAX:
        test_paths_metrics_dataset_types_save_pred = {f"{DATA_PATH}/MinMax_decimal_uniform_test_10k.csv": (MetricFunction.EXACT_NUMBER_ACC, "efficient_number_prompt_pos", True)}
    case Task.INTERVAL:
        test_paths_metrics_dataset_types_save_pred = {f"{DATA_PATH}/Interval_decimal_uniform_test_10k.csv": (MetricFunction.NORMALIZED_QUINT_CLASS_ACC, "efficient_number_prompt_pos", True)}
    case Task.SORTING:
        test_paths_metrics_dataset_types_save_pred = {f"{DATA_PATH}/Sorting_decimal_uniform_test_10k.csv": (MetricFunction.EXACT_NUMBER_ACC, "efficient_number_prompt_pos", True)}
    case Task.MEAN:
        test_paths_metrics_dataset_types_save_pred = {f"{DATA_PATH}/Mean_decimal_uniform_test_10k.csv": (MetricFunction.LOG_SMAPE, "efficient_number_prompt_pos", True)}
    case Task.STD:
        test_paths_metrics_dataset_types_save_pred = {f"{DATA_PATH}/Std_decimal_uniform_test_10k.csv": (MetricFunction.LOG_SMAPE, "efficient_number_prompt_pos", True)}
    case Task.TEXT:
        test_paths_metrics_dataset_types_save_pred = {f"{DATA_PATH}/val_text.txt": (MetricFunction.SCALED_PPL_HARD, "pretokenized_number_pos", False)}
    case _:
